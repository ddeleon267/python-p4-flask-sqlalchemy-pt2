...
#Our app.config is set up to point to our existing database, and 'SQLALCHEMY_TRACK_MODIFICATIONS' 
#is set to False to avoid building up too much unhelpful data in memory when our application is running.
